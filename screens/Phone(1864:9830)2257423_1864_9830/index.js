...
export class Blank extends React.Component {
  ...
  render = () => (
    ...
    >
      ...
      <View style={styles.View_1864_9831}>
        <Text style={styles.Text_1864_9831}>Bill Pay</Text>
      </View>
      <View style={styles.View_1864_9832}>
        <View style={styles.View_1864_9833}>
          <View style={styles.View_1864_9834}>
            <View style={styles.View_1864_9835} />
          </View>
        </View>
      </View>
      <View style={styles.View_1864_9836}>
        <Text style={styles.Text_1864_9836}>Postpaid Bill Payment</Text>
      </View>
      <View style={styles.View_1864_9837}>
        <ImageBackground
          source={{
            uri:
              "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/a7b4/b36d/cf1d6dbd3d56ce5807e90b52cd290a15"
          }}
          style={styles.ImageBackground_1864_9838}
        />
      </View>
      <View style={styles.View_1864_9862}>
        <Text style={styles.Text_1864_9862}>
          Invioce No : SINV/21/03/179572
        </Text>
      </View>
      <View style={styles.View_1864_9863}>
        <Text style={styles.Text_1864_9863}>Service Month : Mar 2021</Text>
      </View>
      <View style={styles.View_1864_9864}>
        <Text style={styles.Text_1864_9864}>Payment Method : Home Visit</Text>
      </View>
      <View style={styles.View_1864_9865}>
        <Text style={styles.Text_1864_9865}>Due Date : 1st to 5th </Text>
      </View>
      <View style={styles.View_1864_9866}>
        <Text style={styles.Text_1864_9866}>Amount : 20,000 Ks</Text>
      </View>
      <View style={styles.View_1864_9867}>
        <View style={styles.View_1864_9868}>
          <View style={styles.View_1864_9869}>
            <View style={styles.View_1864_9870} />
          </View>
        </View>
      </View>
      <View style={styles.View_1864_9871}>
        <Text style={styles.Text_1864_9871}>Postpaid Bill Payment</Text>
      </View>
      <View style={styles.View_1864_9872}>
        <ImageBackground
          source={{
            uri:
              "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/a7b4/b36d/cf1d6dbd3d56ce5807e90b52cd290a15"
          }}
          style={styles.ImageBackground_1864_9873}
        />
      </View>
      <View style={styles.View_1864_9897}>
        <Text style={styles.Text_1864_9897}>Amount : 20,000 Ks</Text>
      </View>
      <View style={styles.View_1864_9898}>
        <Text style={styles.Text_1864_9898}>
          Invioce No : SINV/21/04/179572
        </Text>
      </View>
      <View style={styles.View_1864_9899}>
        <Text style={styles.Text_1864_9899}>Service Month : Apr 2021</Text>
      </View>
      <View style={styles.View_1864_9900}>
        <Text style={styles.Text_1864_9900}>Payment Method : Home Visit</Text>
      </View>
      <View style={styles.View_1864_9901}>
        <Text style={styles.Text_1864_9901}>Due Date : 1st to 5th </Text>
      </View>
      <View style={styles.View_1864_9902}>
        <View style={styles.View_1864_9903}>
          <View style={styles.View_1864_9904}>
            <View style={styles.View_1864_9905} />
          </View>
        </View>
      </View>
      <View style={styles.View_1864_9906}>
        <Text style={styles.Text_1864_9906}>Loan Repayment Late Fee</Text>
      </View>
      <View style={styles.View_1864_9907}>
        <Text style={styles.Text_1864_9907}>Total late fee - 10,000 Ks</Text>
      </View>
      <View style={styles.View_1864_9908}>
        <Text style={styles.Text_1864_9908}>Overdue days- 2</Text>
      </View>
      <View style={styles.View_1864_9909}>
        <Text style={styles.Text_1864_9909}>Day Rate - 5000</Text>
      </View>
      <View style={styles.View_1864_9910} />
      <ImageBackground
        source={{
          uri:
            "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/1e49/e3f1/69144c2c5798bf2b4bf0b8e2f9256384"
        }}
        style={styles.ImageBackground_1864_9911}
      />
      <ImageBackground
        source={{
          uri:
        ...
        style={styles.ImageBackground_1864_9915}
      />
      <View style={styles.View_1864_9936}>
        <ImageBackground
          source={{
            uri:
              "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/d873/560b/cae2af5dee7982f2ee8351cd3bb670bd"
          }}
          style={styles.ImageBackground_1864_9937}
        />
      </View>
      <ImageBackground
        source={{
        ...
        style={styles.ImageBackground_1864_9939}
      />
      <View style={styles.View_1864_9940} />
      <View style={styles.View_1864_9941}>
        <ImageBackground
          source={{
            uri:
              "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/5345/6e93/13df8dfc4c0b426c51b83472e8c6402e"
          }}
          style={styles.ImageBackground_1864_9942}
        />
        <View style={styles.View_1864_9943}>
          <Text style={styles.Text_1864_9943}>
            09-765338440 (9:00 AM to 7:30 PM Everyday)
          </Text>
        </View>
      </View>
      <View style={styles.View_1864_9944}>
        <Text style={styles.Text_1864_9944}>
      ...
      <ImageBackground
        ...
        style={styles.ImageBackground_1864_9945}
      />
      <View style={styles.View_1864_9946} />
      <View style={styles.View_1864_9947}>
        <Text style={styles.Text_1864_9947}>
          Myanmar Net © 2018. All Rights Reserved.
        </Text>
      </View>
      <View style={styles.View_1864_9948}>
        <View style={styles.View_1864_9949}>
          <ImageBackground
            source={{
              uri:
                "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/26b0/4a27/84fcac200d36d95c026d1aa28f0d7d99"
            }}
            style={styles.ImageBackground_1864_9950}
          />
        </View>
      </View>
      <View style={styles.View_1864_9953}>
        <View style={styles.View_1864_9954} />
        <View style={styles.View_1864_9955}>
          <View style={styles.View_1864_9956}>
            <ImageBackground
              source={{
                uri:
                  "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/b765/169d/f553531c03c71999460fc45a2ebcd0d4"
              }}
              style={styles.ImageBackground_1864_9957}
            />
          </View>
        </View>
      </View>
      <View style={styles.View_1864_9960}>
        <View style={styles.View_1864_9961} />
        <View style={styles.View_1864_9962}>
          <ImageBackground
            source={{
              uri:
                "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/690d/4fe4/a6afb654428cf2ba9092b632ec3618d3"
            }}
            style={styles.ImageBackground_1864_9963}
          />
        </View>
      </View>
      <View style={styles.View_1864_9966}>
        <View style={styles.View_1864_9967} />
        <ImageBackground
          source={{
            uri:
              "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/4460/a3ca/1f4b2974d2072810bfadf487be93519b"
          }}
          style={styles.ImageBackground_1864_9968}
        />
      </View>
      <View style={styles.View_1864_9969}>
        <View style={styles.View_1864_9970}>
          <View style={styles.View_1864_9971}>
            <ImageBackground
              source={{
                uri:
                  "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/dff5/fbef/0efc44e786157dd9fbf5616a13085dfe"
              }}
              style={styles.ImageBackground_1864_9972}
            />
          </View>
        </View>
      </View>
      <View style={styles.View_1864_9979}>
        <ImageBackground
          source={{
            uri:
              "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/7f58/c10a/c92240950d799786ce9e36a1e9a58f7b"
          }}
          style={styles.ImageBackground_1864_9980}
        />
      </View>
      <View style={styles.View_1864_9998} />
      <View style={styles.View_1864_9999}>
        <Text style={styles.Text_1864_9999}>Account ID:</Text>
      </View>
      <View style={styles.View_1864_10000}>
        <Text style={styles.Text_1864_10000}>Level:</Text>
      </View>
      <View style={styles.View_1864_10001}>
        <Text style={styles.Text_1864_10001}>423665935</Text>
      </View>
      <View style={styles.View_1864_10002}>
        <View style={styles.View_1864_10003}>
          <View style={styles.View_1864_10004} />
          <ImageBackground
            source={{
              uri:
                "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/2fe7/379a/b432970e8b7f1b211afca9ea4a2a599d"
            }}
            style={styles.ImageBackground_1864_10005}
          />
        </View>
        <View style={styles.View_1864_10006}>
          <Text style={styles.Text_1864_10006}>Registered user</Text>
        </View>
      </View>
      <ImageBackground
        source={{
        ...
        style={styles.ImageBackground_1864_10007}
      />
    </ScrollView>
  )
}
...
const styles = StyleSheet.create({
  ...
  View_1864_9903: {
    width: wp("92.2705240295705%"),
    minWidth: wp("92.2705240295705%"),
    height: hp("16.120218579234972%"),
    minHeight: hp("16.120218579234972%"),
    marginLeft: 0,
    marginTop: 0,
